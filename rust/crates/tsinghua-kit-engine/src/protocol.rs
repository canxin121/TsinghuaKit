...
/// A service whose authenticated session is managed by the session registry.
/// Local TUNet portal operations intentionally use `error::Service::Network`
/// and never create a `ServiceId` session.
