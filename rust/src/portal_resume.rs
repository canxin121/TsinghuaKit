...
mod tests {
    ...
    async fn backend_repair_restored_portal_starts_at_target_sso_not_new_webvpn_login() {
        ...
        let server = thread::spawn(move || {
            ...
            a.write_all(b"HTTP/1.1 302 Found\r\nLocation: https://info.tsinghua.edu.cn/f/info/gxfw_fg/common/index?fixture=1\r\nContent-Length: 0\r\nConnection: close\r\n\r\n").unwrap();
    ...
    async fn backend_repair_webvpn_password_entry_uses_one_trusted_device_recovery_before_retry() {
        ...
        let server = thread::spawn(move || {
            ...
            respond(
                &mut i4,
                "302 Found",
                "Location: https://info.tsinghua.edu.cn/f/info/gxfw_fg/common/index\r\n",
                "",
            );
